...
debug_mode = True  # Set to True if you want to skip sections 10+ for testing json compiling | False to do Full Processing
...
def main(output_directory, current_directory):
    ...
    log_message("\nEDIT what mission pack this player wants in the config...")
