...
finalize R2Modman code share support for MML
EDF EDF EDF
'''

def get_version():
    return "0.0.9.1-R2ModManTest"
...
def create_mod_hosting_services(canvas, y_position):
    ...
    dropdown.pack(side="left", padx=(2, 10))  # Add padding between dropdown and buttons
...
def create_ui(canvas):
    ...
    if RUN_BAT_FILES_ENABLED:
        ...
        bat_button = tk.Button(root, text="Run All BAT Files (3 Directories)", command=run_bat_files_from_dirs, **get_label_style_alt())
