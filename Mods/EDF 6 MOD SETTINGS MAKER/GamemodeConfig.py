        ...
        def confirm_selections():
            ...
            if selected_count.get() > max_selections:
                ...
                try:
                    ...
                    messagebox.showerror("Error", f"Expected a file but found a directory: {config_path}")
                except PermissionError as e:
                    print(f"⚠️ PermissionError: {e}")
                    messagebox.showerror("Error", f"Cannot read {config_path}. Ensure the file is not locked or read-only.")
                except json.JSONDecodeError as e:
                    print(f"❌ JSON Decode Error: {e}")
                    messagebox.showerror("Error", f"CONFIG.json is corrupted: {e}")
